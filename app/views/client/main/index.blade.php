	...
	<div id="wrapper">
		...
		<div class="w1">
					...
					<div class="container">
						<div class="row holder">
							<div class="col-xs-3 col-sm-2">
								<!-- Logo of the page -->
								<div class="logo"><a href="home.html"><img src="@asset('images/logo2.png')" alt="dot"></a></div>
			...
			<main id="main" role="main">
				<!-- Post slider of the page -->
				<section class="posts-slider wow fadeInUp" data-wow-delay="0.6s" style="background-image: url(http://placehold.it/1920x550);">
					<div class="container">
						<div class="row">
							<div class="center-slider mask">
								<!-- slide of the page -->
								<article class="slide">
									<div class="slide-holder">
										<div class="img-holder">
											<img src="http://placehold.it/340x230" alt="image description">
										</div>
										...
										<a href="single-post.html" class="read-more">Continue Reading</a>
									</div>
								</article>
					...
					<div class="row">
						...
						<div id="content" class="col-xs-12">
							...
							<section class="widget profile-widget version-ii hidden-lg hidden-md">
								...
								<h3><a href="#"><img src="@asset('images/text-jhon-aston.png')" alt="jhon aston"></a></h3>
								<p>Hi, I am John Aston. Duis autem vel eum dolor in hendrerit in vulputate velit esse mole consequat, vel illum dolore eu feugiat nulla lisis at vero eros et accumsan et iusto.</p>
								<!-- Social Network of the page -->
								<ul class="social-networks">
									<li><a href="#"><span class="icon ico-facebook"></span></a></li>
							...
							<section class="posts-blocks fullwidth">
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="img-holder">
											<a href="single-post.html"><img src="http://placehold.it/370x245" alt="image description"></a>
										</div>
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="video-holder">
											<a href="https://player.vimeo.com/video/133306855" class="ico-play lightbox fancybox.iframe"></a>
											<img src="http://placehold.it/370x245" alt="image description">
										</div>
										<time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
										<h2><a href="single-post.html">I get up in the morning looking for adventure.</a></h2>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt...</p>
			...
			<aside class="aside version-ii container">
				<div class="row">
					<div class="col-xs-12 holder">
						<div class="col">
							<div class="logo"><a href="#"><img src="@asset('images/logo2.png')" alt="dot"></a></div>
